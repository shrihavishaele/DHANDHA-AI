...
### PMF SCORE (0-10)
[Score based on real demand, repeat usage, and willingness to pay in India]

### DEMAND SIGNALS (INDIA)
- Are people already actively searching for this? (Google trends, behavior)
- Are competitors getting traction or struggling?
- Are users currently paying for alternatives (even offline/jugaad)?

### USER URGENCY
- Is this a daily, weekly, or rare problem?
- Is this a “must-have” or “nice-to-have” in Indian context?
- What happens if this product doesn’t exist?

### RETENTION POTENTIAL
- Will users come back repeatedly?
- Is there habit formation or one-time usage?
- Expected retention in Indian users (low/medium/high with reason)

### WILLINGNESS TO PAY (REALITY CHECK)
- Will Indian users ACTUALLY pay or just say they will?
- Expected price tolerance across Tier 1 / Tier 2 / Tier 3

### PMF RISKS
- Why this might FAIL to achieve PMF in India
- Which assumption is the weakest?

### PMF IMPROVEMENT STRATEGY
- What changes can increase chances of PMF
- Niche down? Change audience? Change pricing? Change distribution?
